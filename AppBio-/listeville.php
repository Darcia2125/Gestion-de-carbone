...
<div  class="container">
  ...
  <p style="text-align: center; color: #004d99 !important;"><a style="color: #004d99 ; float: right;" href="graphe/Statistique.html"></i>VOIR LE GRAPHE</a> 
  </p>
  <br>
  ...
  <tbody>
     ...
     $run_v = mysqli_query($con, $get_v)or die( mysqli_error($con));;
